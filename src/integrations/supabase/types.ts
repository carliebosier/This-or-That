  ...
  public: {
    Tables: {
      ...
      media_assets: {
        ...
        Relationships: [
          {
            foreignKeyName: "media_assets_poll_id_fkey"
            columns: ["poll_id"]
            isOneToOne: false
            referencedRelation: "polls"
            referencedColumns: ["id"]
      ...
      polls: {
        ...
        Relationships: [
          {
            foreignKeyName: "polls_author_guest_id_fkey"
            columns: ["author_guest_id"]
            isOneToOne: false
            referencedRelation: "guest_identities"
            referencedColumns: ["id"]
      ...
      votes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "votes_voter_guest_id_fkey"
            columns: ["voter_guest_id"]
            isOneToOne: false
            referencedRelation: "guest_identities"
            referencedColumns: ["id"]
          },
    ...
    Functions: {
      get_or_create_guest_identity: {
        Args: { fingerprint_hash_input: string }
        Returns: string
      }
      get_user_vote: {
        Args: { guest_id_input?: string; poll_id_input: string }
        Returns: {
          option_id: string
          vote_id: string
        }[]
